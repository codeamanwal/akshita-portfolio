                ...
                <AnimatePresence>
                  {howItsDoneOpen && (
                    ...
                    >
                      ...
                      Every project starts with clarity - on the audience, the market, and <br className="br-desktop"/>the gaps worth owning. Design decisions are rooted in brand <br className="br-desktop"/>strategy, not just aesthetics.
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="border-b border-[#E9DAB6] py-8">
                ...
                <AnimatePresence>
                  {whyItWorksOpen && (
                    ...
                    >
                      <p className="text-[#FEFCE4] leading-6 lg:leading-7 tracking-[-0.31px] lg:tracking-tighter text-sm lg:text-base pr-16">
                      When a brand knows what it stands for, it shows. This kind <br className="br-desktop"/>of alignment builds trust, recognition, and conversion—faster.
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="border-b border-[#E9DAB6] py-8">
                ...
                <AnimatePresence>
                  {whatsDifferentOpen && (
                    ...
                    >
                      <p className="text-[#FEFCE4] leading-6 lg:leading-7 tracking-[-0.31px] lg:tracking-tighter text-sm lg:text-base pr-16">
                      A research-informed, narrative-first approach that positions your<br className="br-desktop"/> brand to lead  - not just compete.
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
